...
#   timestamp: 2026-05-27T12:16:46+00:00
...
class RecurringObject(BaseModel):
    ...
    description: Annotated[
        str, Field(description='An optional description of this recurring item.')
    ]
    status: Annotated[
        Status4,
        Field(
...
class TagObject(BaseModel):
    ...
    text_color: Annotated[str, Field(description='The text color of the tag.')]
    background_color: Annotated[
        str, Field(description='The background color of the tag.')
    ]
    updated_at: Annotated[
        AwareDatetime,
        Field(
...
class CreateManualAccountRequestObject(BaseModel):
    ...
    status: Annotated[Status | None, Field(description='The status of the account')] = Status.active
    closed_on: Annotated[
...
class SummaryCategoryOccurrenceObject(BaseModel):
    ...
    budgeted_currency: Annotated[
        CurrencyEnum, Field(description='Currency of the budgeted amount')
    ]
    notes: Annotated[str, Field(description='Any notes set for the budget period.')]
