...
class CreateCategoryRequestObject(BaseModel):
    ...
    children: Annotated[
        list[int | Children | CategoryObject],
        Field(
...
class CreateManualAccountRequestObject(BaseModel):
    ...
    status: Annotated[Status, Field(description="The status of the account")] = "active"
    closed_on: Annotated[
...
class ChildTransactionObject(BaseModel):
    ...
    files: Annotated[
        list[TransactionAttachmentObject],
        Field(
